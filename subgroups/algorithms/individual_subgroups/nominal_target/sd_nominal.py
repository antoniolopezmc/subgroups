...
class SD(Algorithm):
    ...
    __slots__ =( "g_parameter,_minimum_quality_measure_value","beam_width","_quality_measure", "_additional_parameters_for_the_quality_measure", "_unselected_subgroups", "_selected_subgroups", "_file_path", "_file")
    def __init__(self, g_parameter: Union[int,float], minimum_quality_measure_value: Union[int,float],quality_measure : QualityMeasure, additional_parameters_for_the_quality_measure : dict[str, Union[int, float]] = dict(),  beam_width = 20 ,write_results_in_file : bool = False, file_path : Union[str, None] = None) -> None:
